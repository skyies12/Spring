...
<body>
      <div id="wrap">
       <!-- header -->
        ...
        <div class="contents">
           <div id="wrap1">
			<form action ="<c:url value='j_spring_security_check?num=4'/>" method="post" id="reg_frm">
		...
		<c:if test="${SPRING_SECURITY_LAST_EXCEPTION != NULL }">
			message: <c:out value="${SPRING_SECURITY_LAST_EXCEPTION.message }"></c:out>
				...
				<div id="idwrap" class="input"><input placeholder="아이디" type="text" name="j_username" id="id" value="<% if(session.getAttribute("id") != null) {
                																out.println(session.getAttribute("id"));
          																			}%>"></div>
				<div id="pwwrap" class="input"><input placeholder="비밀번호" type="password" name="j_password" id="pw"></div>
				<input id="join" type="submit" name="id" value="로그인" ">
				<div id="naverIdLogin">
