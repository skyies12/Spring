...
<link href="http://netdna.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.css" rel="stylesheet">
  ...
  <link href="resources/css/modify_view.css" rel="stylesheet">
    <title>K.SW Project</title>
</head>
<body>
<c:set var="contname" value="${content_view.bName }"/>
...
String contname = (String)pageContext.getAttribute("contname");
%>
      <div id="wrap">
       <!-- header -->
        <header>
		...
		<form name="modify_form" action="modify?bNum=<%=bNum %> method="post">
		...
		<tr style="display:none;">
			...
			<tr>
				...
				<td><input id="context" type="text" size="40" name="bTitle" value="${content_view.bTitle }"></td>
			</tr>
			<tr>
				<td  class="cname">내용</td>
				<td><textarea style="resize: none;" name="bContent" id="summernote" rows="10" cols="100" placeholder="내용을 입력하세요">${content_view.bContent }</textarea></td>
			<script>
			...
			<tr>
				<td id="td" colspan="2">
					<div id="wbtn">
						<input class="wbtn" type="button" value="수정" onclick="form_check()">&nbsp;
						<a class="wbtn" href="content_view?name=<%=contname %>&bNum=<%=bNum %>&bId=${content_view.bId }&kind=modify">취소</a>
					</div>
				</td>
			</tr>
		</form>
	...
	<script src="resources/js/modify_view.js"></script> 
</body>
</html>