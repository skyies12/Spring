...
<link href="http://netdna.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.css" rel="stylesheet">
  ...
  <link href="resources/css/upload_view.css" rel="stylesheet">
...
%>
      <div id="wrap">
       <!-- header -->
		...
		<form action="filesUpload?bNum=<%=bNum %>" method="post" name="ref_frm"  enctype="Multipart/form-data">
    ...
    <script src="resources/js/upload_view.js"></script> 
