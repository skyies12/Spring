       ...
       <!-- header -->
		...
		<tr style="display:none;">
			...
			<tr>
				...
				<td><input id="context" type="text" size="40" name="bTitle" value="${content_view.bTitle }" placeholder="게시글 제목을 입력하세요"></td>
			</tr>
			<tr>
				<td>첨부파일</td>
				<td><input id="fileName" type="file" name="fileName1" /></td>
			</tr>
			<tr>
				<td  class="cname">내용</td>
				<td><textarea  name="bContent" id="summernote" rows="10" cols="100" placeholder="내용을 입력하세요">${content_view.bContent }</textarea></td>
			<script>
